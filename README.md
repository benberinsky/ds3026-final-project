...
This project explores how student characteristics relate to academic performance, measured by cumulative GPA.
...
**Predictive Task:** Can we predict the cumulative grade point average of a new student based on the information present in the dataset, specifically lifestyle, demographic, and past academic information?

**Differentiation:** The key distinction is that our inferential question focuses on estimating a specific population parameter (the true mean difference in GPA), whereas our predictive task focuses on minimizing error for individual observations (unseen students).
